...
import { getAccountantById } from "../../api/accountantOperation";
...
const Accountant = () => {
  ...
  useEffect(() => {
    getAccountantById(id).then((res) => setAccountant(res));
  }, [id]);
        ...
        <div className="max-w-xl h-full p-6 py-12 lg:ml-20 lg:px-8 lg:max-w-[1420px]">
          <div className="flex flex-col lg:flex-row gap-36">
            <div className="lg:w-96 h-96 ">
              ...
              <div className="w-full max-w-sm px-5 py-5 bg-white rounded-md shadow-md">
                <div className="flex justify-between">
                  ...
                  <span className="text-base font-bold">{accountant.price}</span>
                </div>
              ...
              <div className="mt-6 rounded-lg border border-gray-100 bg-white p-6">
                ...
                <p className="mt-3">{accountant.testimonial?.text}</p>
            ...
            <div>
              ...
              />
              <div className="w-5/6">
                <h2 className="text-4xl font-bold my-8">About {accountant.name}</h2>
                <div className="flex justify-between gap-12">
                  <div>
                    <p className="text-[#999] font-semibold">FROM</p>
                    <p className="text-lg">{accountant.about?.from}</p>
                  </div>
                  <div>
                    <p className="text-[#999] font-semibold">PARTNER SINCE</p>
                    <p className="text-lg">{accountant.about?.partnerSince}</p>
                  </div>
                  <div>
                ...
                <div className="my-8">
                  ...
                  <p className="text-lg">{accountant.about?.description}</p>
                </div>
                <div className="flex justify-between">
                  <div>
